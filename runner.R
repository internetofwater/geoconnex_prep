...
plan <- drake_plan(nwis_sites = get_nwis_sites(),
                   ...
                   nat_aq_out = write_nat_aq(nat_aq,
                                             ...
                                             pa_base = "https://geoconnex.us/ref/principle_aq/",
                                             links = nat_aq_links,
                   ...
                   pa_out = write_pa(principle_aquifer,
                                     pid_base = "https://geoconnex.us/ref/principle_aq/",
                                     landing_base = "https://reference.geoconnex.us/collections/principle_aq/items/",
                                     nat_aq_out,
                   ...
                   shr_out = write_shr(secondary_hydrogeologic_regions,
                                       ...
                                       landing_base = "https://reference.geoconnex.us/collections/sec_hydro_reg/items/",
